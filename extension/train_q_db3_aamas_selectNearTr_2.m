function train_q_db3_aamas_selectNearTr_2()
%  
...
opts.num_camera = 4;
opts.numEpoch = 300000;

task = 1; % 0 for train, 1 for test
% Q_table_name = './models/q_tableRL_db3_aamas_200.mat';
Q_table_name = './models/q_tableRL_db3_pICAPS_te1_tel400_selectNearTr_el200_f1.mat';
% opts.num_camera = 5;
if task == 0
    
    load('./models/q_tableRL_db3_pICAPS_te1_tel400_selectNearTr_el200_f1.mat', 'Qc')  
    [Qc,reward,rew_allep] = train_db3_postICAPS_3rew_selectNearTr_2(opts, Q_table_name,Qc);  
