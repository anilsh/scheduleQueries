function train_q_db3_aamas_selectNearTr_te2_f2()
%  
...
opts.num_camera = 4;
opts.numEpoch = 230000;

task = 1; % 0 for train, 1 for test
% Q_table_name = './models/q_tableRL_db3_aamas_200.mat';
Q_table_name = './models/q_tableRL_db3_pICAPS_te2_tel400_selectNearTr_el100_largeR_fpsc2_3.mat';
% opts.num_camera = 5;
if task == 0
    
    load('./models/q_tableRL_db3_pICAPS_te2_tel400_selectNearTr_el100_largeR_fpsc2_3.mat', 'Qc')  
    [Qc,reward,rew_allep] = train_db3_postICAPS_3rew_selectNearTr_te2_f2(opts, Q_table_name,Qc);  
