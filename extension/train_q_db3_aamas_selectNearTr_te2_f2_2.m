function train_q_db3_aamas_selectNearTr_te2_f2_2()
%  
...
Q_table_name = './models/q_tableRL_db3_pICAPS_te2_tel400_selectNearTr_el200_largeR_fpsc2_2rew_f1.mat';
% opts.num_camera = 5;
if task == 0
    
    load('./models/q_tableRL_db3_pICAPS_te2_tel400_selectNearTr_el200_largeR_fpsc2_2rew.mat', 'Qc')  
    [Qc,reward,rew_allep] = train_db3_postICAPS_selectNearTr_te2_f2(opts, Q_table_name);  
