function train_q_db3_aamas_selectNearTr()
%  
...
Q_table_name = './models/q_tableRL_db3_pICAPS_te1_tel400_selectNearTr_f1.mat';
% opts.num_camera = 5;
if task == 0
    
    load('./models/q_tableRL_db3_pICAPS_te1_tel400_selectNearTr.mat', 'Qc')  
    [Qc,reward,rew_allep] = train_db3_postICAPS_3rew_selectNearTr(opts, Q_table_name, Qc);  
