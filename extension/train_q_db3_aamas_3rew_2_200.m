function train_q_db3_aamas_3rew_2_200()
%  
...
if task == 0
    ...
    [Qc,reward,rew_allep] = train_QcamPolicy_db3_aamas_postICAPS_3rew_2_200(opts, Q_table_name,Qc);  
    save(Q_table_name, 'Qc','-v7.3')  
    %save('./results/q_results_db3_pICAPS_3rew_te2_tel200.mat', 'reward','rew_allep');
end
if task == 1
    load(Q_table_name, 'Qc')  
