function train_q_db3_aamas_singleCamTrain()
%  
...
Q_table_name = './models/q_tableRL_db3_pICAPS_te1_tel400_singleCamTrain_2f1.mat';
% opts.num_camera = 5;
if task == 0
    
    load('./models/q_tableRL_db3_pICAPS_te1_tel400_singleCamTrain_2.mat', 'Qc')  
    [Qc,reward,rew_allep] = train_db3_postICAPS_3rew_singleCamTrain(opts, Q_table_name,Qc);  
